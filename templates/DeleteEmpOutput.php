<?php
	...
	$content1 = "DELETE UNSUCCESSFUL!";
	$content2 = "Employee ID Not Found!";
	$name = "";
	if($resultCheck == 1){
		$row = mysqli_fetch_assoc($result);
		$keyName = $row['images_key'];
		...
		$result = mysqli_query($conn, $sql);
		$content1 = "DELETE SUCCESSFULLY!";
		$content2 = "Employee Name: $name has been removed!";
	}
?>
...
<body>
	...
	<div class="container">
		<div class="title">Delete Employee Output</div><br/>
		<div class="content">
			<p class="content_1">
				<?php
					echo "$content1";
