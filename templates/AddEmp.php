...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      <form action="AddEmpOutput.php" autocomplete="on" method = "POST" enctype="multipart/form-data">
        <div class="card">
          <img id="myimage" width="200" height="200" style="margin-left: auto; margin-right: auto;">
        </div>
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" id="pri_skill" name="pri_skill" placeholder="Enter your primary skills" required/>
          </div>
          <div class="input-box">
            <span class="details">Location</span>
            <input type="text" id="locations" name="locations" placeholder="Enter your location" required/>
          </div>
          <div class="input-box">
            <span class= "details">Image</span>
            <input type="file" id="images" name="images" onChange="preview_2(this);" accept="image/*" required/>
          </div>
        </div>
        <div class= "button">
			    <input type="submit" onclick="return check()" value="ADD EMPLOYEE">
        </div>
      </form>
    </div>
  </div>
